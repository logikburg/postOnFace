                        ...
                        <nav class="navbar navbar-default">
                                <div class="row custom-row-padding">
                                        ...
                                        <div class="navbar-header">
                                                ...
                                                <a class="navbar-brand" href="#">PostOnFace</a>
                                        </div>
                        ...
                        <div class="container">
                                <div class="row">
                                        <div class="col-sm-3">
                                                <div class="tabbable">
                                                        ...
                                                        <ul class="nav nav-tabs custom-nav-margin-bottom">
                                                                <li class="active"><a href="#tab1" data-toggle="tab">Background</a></li>
                                                        ...
                                                        <div class="tab-content">
                                                                <div class="tab-pane active" id="tab1">
                                                                        <div class="well thumbs">
                                                                                <img style="cursor:pointer;height: 104px;width: 228px;" class="img-polaroid bg-thumbnail" src="img/image1.jpg">
                                                                                <img style="cursor:pointer;height: 104px;width: 228px;" class="img-polaroid bg-thumbnail" src="img/image7.jpg">
                                                                                <img style="cursor:pointer;height: 104px;width: 228px;" class="img-polaroid bg-thumbnail" src="img/image8.jpg">
                                                                                <img style="cursor:pointer;height: 104px;width: 228px;" class="img-polaroid bg-thumbnail" src="img/image2.jpg">
                                                                                <img style="cursor:pointer;height: 104px;width: 228px;" class="img-polaroid bg-thumbnail" src="img/image3.jpg">
                                                                                <img style="cursor:pointer;height: 104px;width: 228px;" class="img-polaroid bg-thumbnail" src="img/image4.jpg">
                                                                                <img style="cursor:pointer;height: 104px;width: 228px;" class="img-polaroid bg-thumbnail" src="img/image5.jpg">
                                                                                <img style="cursor:pointer;height: 104px;width: 228px;" class="img-polaroid bg-thumbnail" src="img/image6.jpg">
                                                                                <img style="cursor:pointer;height: 104px;width: 228px;" class="img-polaroid bg-thumbnail" src="img/image5.jpg">
                                                                                <img style="cursor:pointer;height: 104px;width: 228px;" class="img-polaroid bg-thumbnail" src="img/image6.jpg">
                                                                                <img style="cursor:pointer;height: 104px;width: 228px;" class="img-polaroid bg-thumbnail" src="img/image5.jpg">
                                                                                <img style="cursor:pointer;height: 104px;width: 228px;" class="img-polaroid bg-thumbnail" src="img/image6.jpg">
                                                                ...
                                                                <div class="tab-pane" id="tab2">
                                                                        <div class="well">
                                                                                <select id="sizesTypes" style="width: 100%;">
                                                                                        <option value="1" selected="selected">320x480</option>
                                                                                </select>
                                                                        </div>

                                                                        <div class="well layoutThumbs selection-container">
                                                                                <ul class="list-group">
                                                                                        <li class="list-group-item">
                                                                                                <label class="btn btn-checkbox" data-value="1">
                                                                                                        <div class="sel-content">
                                                                                                                <img style="cursor: pointer;height: 48px;width: 100%;" class="img-responsive" src="img/text_header.png">
                                                                                        ...
                                                                                        <li class="list-group-item">
                                                                                                <label class="btn btn-checkbox" data-value="2">
                                                                                                        <div class="sel-content">
                                                                                                                <img style="cursor:pointer;height: 48px;width: 100%;" class="img-responsive" src="img/text_body.png">
                                                                                                                <!--                                                                                                <span class="glyphicon glyphicon-ok glyphicon-lg"></span>-->
                                                                                                                <h5>Body</h5>
                                                                                                        </div>
                                                                                                </label>
                                                                                        ...
                                                                                        <li class="list-group-item">
                                                                                                <label class="btn btn-checkbox" data-value="3">
                                                                                                        <div class="sel-content">
                                                                                                                <img style="cursor:pointer;height: 48px;width: 100%;" class="img-responsive" src="img/text_footer.png">
                                                                                                                <!--                                                                                                <span class="glyphicon glyphicon-ok glyphicon-lg"></span>-->
                                                                                                                <h5>Signature</h5>
                                                                                                        </div>
                                                                                                </label>
                                                                ...
                                                                <div class="tab-pane" style="height:auto;" id="tab3">
                                                                        <p style="font-size: 12px; margin: 0 0 0px;">* Note: only one design can be used.</p>
                                                                        <div class="well classicThumbs">
                                                                                <img style="cursor:pointer;" class="img-art img-thumbnail" src="img/daisy-flower-100x100.png">
                                                                        ...
                                                                        <hr>
                                                                        <button class="btn btn-primary">Upload Design</button>
                                                                </div>
                                                        </div>
                                                </div>
                                        </div>
                                        <div class="col-sm-6">
                                                ...
                                                <div class="well" style="height:140px; width:480px;margin-top: 20px;padding-top:8px;">
                                                        ...
                                                        <textarea id="text-string" cols="180" rows="2" name="data" class="custome" placeholder="add text here..." style="line-height: 1.5em; font-family: Arial, Helvetica, sans-serif; font-size: 14px;"></textarea>
                ...
                <script>
                        ...
                        function checkAuth(userdata) {
                                $.ajax({
                                        ...
                                        url: "/slim/src/index.php/initApp",
                                        data: userdata,
                                ...
                                if (_dload) {
                                        if (("download" == event.target.id) ||
                                                ...
                                                $.ajax({
                                                        ...
                                                        data: _reqData,
                                                        cache: false,
                                                        url: "/slim/src/index.php/publish",
                                                        success: function(data) {
